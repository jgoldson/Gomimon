# GomiMon 0.4.0 — Chrome Web Store release
...
All 278 tests passed: 197 Jest, 42 detector, 35 server, and 4 website tests. Server syntax checks and git whitespace checks passed. The store verifier checked 67 packaged files against current source and verified manifest and HTML/CSS/module references.

## Store draft and remaining steps
...
- Production ID: `ffbifkhfophelclnkmibepadfednkbnf`; version 0.4.0.
...
- The publisher explicitly confirmed all three data-use certifications on 2026-09-22. All three are checked and saved; the dashboard confirmed “Item saved” and enabled Submit for review. Nothing has been submitted for review.
...
After the listing is published, put its verified URL in `website/config.js` and rebuild the marketing website. Do not ship a guessed listing URL.
